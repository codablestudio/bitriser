...
data class V0WebhookDeliveryItemResponseModel(
    ...
    @Json(name = "response_body") @field:Json(name = "response_body") var responseBody: String? = null,
    @Json(name = "response_headers") @field:Json(name = "response_headers") var responseHeaders: String? = null,
    @Json(name = "response_http_status") @field:Json(name = "response_http_status") var responseHttpStatus: String? = null,
    @Json(name = "response_seconds") @field:Json(name = "response_seconds") var responseSeconds: String? = null,
