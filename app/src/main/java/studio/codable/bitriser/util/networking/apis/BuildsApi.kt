...
import studio.codable.bitriser.util.networking.models.V0BuildListAllResponseModel
import studio.codable.bitriser.util.networking.models.V0BuildListResponseModel
import studio.codable.bitriser.util.networking.models.V0BuildLogInfoResponseModel
import studio.codable.bitriser.util.networking.models.V0BuildShowResponseModel
import studio.codable.bitriser.util.networking.models.V0BuildTriggerParams
import studio.codable.bitriser.util.networking.models.V0BuildTriggerRespModel
import studio.codable.bitriser.util.networking.models.V0BuildWorkflowListResponseModel
...
interface BuildsApi {
    ...
    suspend fun buildList(
        @retrofit2.http.Path("app-slug") appSlug: String,
        @retrofit2.http.Query("sort_by") sortBy: String? = null,
        @retrofit2.http.Query("branch") branch: String? = null,
        @retrofit2.http.Query("workflow") workflow: String? = null,
        @retrofit2.http.Query("commit_message") commitMessage: String? = null,
        @retrofit2.http.Query("trigger_event_type") triggerEventType: String? = null,
        @retrofit2.http.Query("pull_request_id") pullRequestId: Int? = null,
        @retrofit2.http.Query("build_number") buildNumber: Int? = null,
        @retrofit2.http.Query("after") after: Int? = null,
        @retrofit2.http.Query("before") before: Int? = null,
