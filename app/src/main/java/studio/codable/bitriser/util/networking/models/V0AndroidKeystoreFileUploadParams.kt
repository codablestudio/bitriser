...
data class V0AndroidKeystoreFileUploadParams(
    @Json(name = "alias") @field:Json(name = "alias") var alias: String? = null,
    @Json(name = "password") @field:Json(name = "password") var password: String? = null,
    @Json(name = "private_key_password") @field:Json(name = "private_key_password") var privateKeyPassword: String? = null,
